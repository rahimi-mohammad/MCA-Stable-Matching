...
%% curves
% figure
% bar(1:N,sum(sum(received_power_MCA)/N_trial,0.3))
% title('Stable Matching')
% xlabel('nodes')
% ylabel('receiver average power')
% figure
% bar(1:M,sum(received_power_WCA)/N_trial,0.3)
% title('Stable Matching')
% xlabel('channels')
% ylabel('receiver average power')
sum(sum(received_power_MCA)/N_trial)
sum(sum(received_power_WCA)/N_trial)
MCA_pairs
WCA_pairs
